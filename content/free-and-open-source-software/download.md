...
<p><br />The Modelica Development Tooling (MDT) Eclipse Plug-In integrates the  <a href="https://www.openmodelica.org">OpenModelica</a> compiler with <a href="https://www.eclipse.org./">Eclipse</a>.  MDT, together with the OpenModelica compiler, provides an environment for working with <a href="https://www.modelica.org/">Modelica</a> projects.</p>
...
<p>The most convenient way to install MDT is by instructing Eclipse to fetch the plugin from the<br /> update site which is located at <a href="https://www.ida.liu.se/%7Epelab/modelica/OpenModelica/MDT/"> https://www.ida.liu.se/~pelab/modelica/OpenModelica/MDT/</a>.<br /> If you are not sure how to accomplish this, just follow the instructions below.</p>
